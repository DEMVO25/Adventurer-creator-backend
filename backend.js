...
db.run('CREATE TABLE IF NOT EXISTS characters(name text UNIQUE, classlevel TEXT, background TEXT, race TEXT, alignment TEXT, experience INTEGER, strengthmod TEXT, strengthnumber INTEGER, dexmod TEXT, dexnumber INTEGER, username	TEXT, constitutionmod TEXT, constitutionnumber INTEGER, intelligencemod TEXT, intelligencenumber INTEGER,  wisdommod TEXT, wisdomnumber INTEGER , charismamod TEXT , charismanumber INTEGER , inspiration INTEGER, proficiencybonus TEXT , strstcheck BOOL, strengthsavingthrow TEXT, dexstcheck BOOL, dexteritysavingthrow TEXT, constcheck BOOL, constitutionsavingthrow TEXT, intstcheck BOOL, intelligencesavingthrow TEXT, wisstcheck BOOL,  wisdomsavingthrow TEXT, chastcheck BOOL, charismasavingthrow TEXT, acrobatics TEXT, acrobaticscheck BOOL, animalhandlingcheck BOOL, animalhandling BOOL, arcanacheck BOOL, arcana TEXT, athleticscheck BOOL ,athletics TEXT, deceptioncheck BOOL, deception TEXT, historycheck BOOL,  history TEXT, insightcheck BOOL ,insight TEXT, intimidationcheck BOOL, intimidation TEXT, investigationcheck BOOL, investigation TEXT, medicinecheck BOOL, medicine TEXT, naturecheck BOOL,nature TEXT, perceptioncheck BOOL, perception TEXT, perfomancecheck BOOL, perfomance TEXT , persuasioncheck BOOL, persuasion TEXT , religioncheck BOOL,religion TEXT , sleightofhandscheck BOOL , sleightofhands TEXT , stealthcheck BOOL, stealth TEXT , survivalcheck BOOL,survival TEXT ,passivewisdom INTEGER ,proficienciestextarea TEXT ,armor INTEGER ,initiative TEXT ,speed INTEGER ,currenthitpoints TEXT ,temporaryhitpoints TEXT ,hitdice TEXT,weapon1 TEXT,atkbonus1 TEXT,dmg1 TEXT,weapon2 TEXT,atkbonus2 TEXT,dmg2 TEXT ,weapon3 TEXT,atkbonus3 TEXT,dmg3 TEXT,cp INTEGER,sp INTEGER,ep INTEGER,gp INTEGER,pp INTEGER,equipmenttextarea TEXT,personality TEXT,ideals TEXT,bonds TEXT,flaws TEXT, FOREIGN KEY(username) REFERENCES users (username))')
...
app.post('/sheet', (req, res) => {
  ...
  db.run('UPDATE characters SET classlevel = ?, background = ?, race = ?, alignment = ?, experience = ?, strengthmod = ?, strengthnumber = ?, dexmod = ?, dexnumber =?, constitutionmod = ?, constitutionnumber = ?, intelligencemod = ?, intelligencenumber = ?, wisdommod = ?, wisdomnumber = ?, charismamod = ?, charismanumber = ?, inspiration = ?, proficiencybonus = ?, strengthsavingthrow = ?, dexteritysavingthrow = ?, constitutionsavingthrow = ?, intelligencesavingthrow = ?, wisdomsavingthrow = ?, charismasavingthrow = ?, acrobaticscheck = ?, acrobatics = ?, animalhandlingcheck = ?, animalhandling = ?, arcanacheck = ?, arcana = ?, athleticscheck = ?, athletics = ?, deceptioncheck = ?, deception = ?, historycheck = ?, history = ?, insightcheck = ?, insight = ?, intimidationcheck = ?, intimidation = ?, investigationcheck = ?, investigation = ?, medicinecheck = ?, medicine = ?, naturecheck = ?, nature = ?, perceptioncheck = ?, perception = ?, perfomancecheck = ?, perfomance = ?, persuasioncheck = ?, persuasion = ?, religioncheck = ? , religion = ?,'+
    ' sleightofhandscheck = ?, sleightofhands = ?, stealthcheck = ?, stealth = ?, survivalcheck = ?, survival = ?, passivewisdom = ?, proficienciestextarea = ?, armor = ?, initiative = ?, speed = ?, currenthitpoints = ?, temporaryhitpoints = ?, hitdice = ?, weapon1 = ?, atkbonus1 = ?, dmg1 = ?, weapon2 = ?, atkbonus2 = ?, dmg2 = ?, weapon3 = ?, atkbonus3 = ?, dmg3 = ? WHERE name = ?', [classlevel, background, race, alignment, experience, strengthmod, strengthnumber, dexteritymod, dexteritynumber, constitutionmod, constitutionnumber, intelligencemod, intelligencenumber, wisdommod, wisdomnumber, charismamod, charismanumber, inspiration, proficiencybonus, strengthsavingthrow, dexteritysavingthrow, constitutionsavingthrow, intelligencesavingthrow, wisdomsavingthrow, charismasavingthrow, acrobaticscheck, acrobatics, animalhandlingcheck, animalhandling, arcanacheck, arcana, athleticscheck, athletics, deceptioncheck, deception, historycheck, history, insightcheck, insight, intimidationcheck, intimidation, investigationcheck, investigation, medicinecheck, medicine, naturecheck, nature, perceptioncheck, perception, perfomancecheck, perfomance, persuasioncheck, persuasion, religioncheck, religion, sleightofhandscheck, sleightofhands, stealthcheck, stealth, survivalcheck, survival, passivewisdom, proficienciestextarea, armor, initiative, speed, currenthitpoints, temporaryhitpoints, hitdice, weapon1, atkbonus1, dmg1, weapon2, atkbonus2, dmg2, weapon3, atkbonus3, dmg3, name], (err) => {
    if (err) {
